function Footer() {
    return ( 
            <div className='bg-[#ff615a]'>
                ...
                <ul className='flex justify-evenly'>
                    ...
                    <li>
                        <a className="flex flex-row-reverse gap-1 items-center"href="https://www.linkedin.com/in/douglas-melo-217088213/" target="_blank" rel="noopener noreferrer">
                            <p>Linkedin</p>
                            <svg className=' text-black hover:text-white' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16" fill='currentColor'>
                ...
                <p className='text-center'>© 2024 Douglas dos Santos Melo</p>
        </div>
     );
}
